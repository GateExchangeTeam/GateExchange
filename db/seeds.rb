...
c.posts.create!(title: 'uninitialized constant when including validator',
                description: 'I have the following file /app/validators/hex_color.rb in my Rails app but I got an error', view: 0)
c.posts.create!(title: 'Rotating an image using cImage',
...
c.posts.create!(title: 'Prefix number with + if it is positive - Ruby / Rails 4',
...
c.posts.create!(title: 'Sort hash by key, return hash in Ruby',
                description: 'Would this be the best way to sort a hash and return Hash object (instead of Array):', view: 0)
c1.posts.create!(title: 'How to check if a value exists in an array in Ruby',
                 description: "I have a value 'Dog' and an array ['Cat', 'Dog', 'Bird'].", view: 0)
c1.posts.create!(title: 'Navbar fixed on the top of HTML page (CSS / HTML)',
