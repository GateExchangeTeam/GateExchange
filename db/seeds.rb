...
p2.comments.create!([
                      { text_body: 'This might fix your problem' },
                     { text_body: 'I have the same issue' },
                     { text_body: 'Waiting here for someone to fix this issue' },
                     { text_body: 'Try this solution: ........' },
                     {text_body: 'This might fix your problem'},
                      {text_body: 'You are beyond help'}])
